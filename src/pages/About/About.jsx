        ...
        <div className=" bg-[#0b1a20] py-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto ">
                <div data-aos="fade-right"
                    data-aos-offset="300"
                    data-aos-easing="ease-in-sine" className="md:col-start-1 bg-[#000e0e] p-5 shadow-2xl border-r-8 border-[#29ffff] rounded-xl">
                ...
                <div data-aos="fade-right"
                    data-aos-offset="300"
                    data-aos-easing="ease-in-sine" className="md:col-start-2  bg-[#000e0e] p-5 shadow-2xl border-l-8 border-[#29ffff] rounded-xl">
                    <div className="flex justify-between">
                ...
                <div data-aos="fade-right"
                    data-aos-offset="300"
                    data-aos-easing="ease-in-sine" className="md:col-end-1 md:col-start-1 bg-[#000e0e] p-5 shadow-2xl border-r-8 border-[#29ffff] rounded-xl">
                    <div className="flex justify-between">
